...
// Plasmic Project: 56i38yEGPn8fnfwshSAHgK
// Component: AlpsZ6uZsjNm
...
import projectcss from "./plasmic_my_app.module.css"; // plasmic-import: 56i38yEGPn8fnfwshSAHgK/projectcss
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: AlpsZ6uZsjNm/css

import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: H3dAzti0RHQu/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: JxK5nMH193l3/icon
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__e8D8A)}
              role={"img"}
            />
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__rmtYj)}
              role={"img"}
            />
          ),
